...
*Manual: [Truncation](../../manual/propagation/truncation.md), [Direction](../../manual/propagation/direction.md)*
...
exactly the norm discarded** — the [retained-norm diagnostic](../../manual/propagation/validation.md#read-the-retained-norm) behind every curve below.
...
circuit reproduce exactly](../../manual/propagation/incremental.md#splitting-a-circuit-is-free) the (apply-adjoint, truncate) sequence of one call
