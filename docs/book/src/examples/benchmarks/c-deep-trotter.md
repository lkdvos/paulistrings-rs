...
*Manual: [Validating a result](../../manual/propagation/validation.md)*
...
truncated Pauli sum has [no variational bound](../../manual/propagation/truncation.md#no-variational-bound). The grid is nowhere near
...
B2](../showcases/b2-noisy-verification.md#reachability-boundary-with-and-without-noise)
...
construction](../../manual/propagation/settings.md#estimate-the-memory-a-run-needs) (3.1·10⁶ terms × 48 B at `W=2`), and the whole 42-run
