...
*Manual: [Noise channels](../../manual/circuits.md#noise-channels), [Truncation](../../manual/propagation/truncation.md)*
...
The [plateau verdict](../../manual/propagation/validation.md#apply-the-plateau-criterion) reuses Benchmark B's criterion unchanged, and rejects `p = 1e-3`:
...
[Benchmark C's measured reachability boundary](../benchmarks/c-deep-trotter.md#reachability-requirements).
