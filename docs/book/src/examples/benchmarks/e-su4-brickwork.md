...
*Manual: [Truncation](../../manual/propagation/truncation.md)*
...
guaranteed monotone](../../manual/propagation/truncation.md#no-variational-bound) in the cutoff for a generic, non-sign-coherent operator.
...
Schema v1's [`unitary_2q`](../../manual/circuits.md#building-a-circuit) gate is exactly the SU(4) block this circuit is built
