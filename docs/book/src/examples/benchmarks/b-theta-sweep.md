...
*Manual: [Validating a result](../../manual/propagation/validation.md), [Truncation](../../manual/propagation/truncation.md)*
...
Pauli sum has [no variational bound](../../manual/propagation/truncation.md#no-variational-bound) against it. The CI test asserts
...
[`RAYON_NUM_THREADS=1`](../../manual/propagation/settings.md#threads) must be exported before the interpreter starts; the
