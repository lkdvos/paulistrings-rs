...
The companion [Performance](performance.md) page puts measured numbers to each claim; [`ARCHITECTURE.md`](https://github.com/lkdvos/paulistrings-rs/blob/main/ARCHITECTURE.md) is the invariants-only reference this page narrates — cited by section below rather than restated in full.
