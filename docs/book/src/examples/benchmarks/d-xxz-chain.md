...
*Manual: [Truncation](../../manual/propagation/truncation.md), [Stats, memory and logging](../../manual/propagation/settings.md)*
...
memory tracks the term count and the compile-time width tier](../../manual/propagation/settings.md#estimate-the-memory-a-run-needs), and nothing else: for the `Jz=0.5`,
...
reach 3·10⁻⁷. The [error is not monotone](../../manual/propagation/truncation.md#no-variational-bound) in the cutoff (`Jz=0`: 3.3e−6 at 1e−4, then 9.0e−6 at 1e−5; `Jz=0.5`:
