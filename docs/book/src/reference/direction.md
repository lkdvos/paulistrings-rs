...
[Propagation direction](../how-to/choose-propagation-direction.md) has the same circuit and observable run both ways, with the two different numbers.
...
See [Propagation direction](../how-to/choose-propagation-direction.md) for guidance on which picture answers which question.
